...
// function to create a new dog in database
...
const searchDog = async (req, res) => {
  ...
  const ageIncrease = Number(1) || 0;

  return res.json({ name: doc.name, age: doc.age + ageIncrease });
};
